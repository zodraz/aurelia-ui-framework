define(["require", "exports", "./core/ui-viewport", "./utils/ui-event", "./utils/ui-formatters", "./utils/ui-utils", 'fetch', 'lodash', 'moment', 'numeral', './libs/marked', './libs/phonelib', './data/countries', './data/currencies'], function (require, exports, ui_viewport_1, ui_event_1, ui_formatters_1, ui_utils_1) {
