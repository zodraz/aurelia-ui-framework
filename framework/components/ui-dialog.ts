...
export class UIDialogService {
	...
	private move($event) {
		...
		let t  = parseInt(this.__dialog.style.top);
		let l  = parseInt(this.__dialog.style.left);
		let w  = parseInt(this.__dialog.style.width);
		let h  = parseInt(this.__dialog.style.height);
