...
define(["require", "exports", "aurelia-framework", "../utils/ui-utils", "../utils/ui-event", "aurelia-metadata", "aurelia-framework"], function (require, exports, aurelia_framework_1, ui_utils_1, ui_event_1, aurelia_metadata_1, aurelia_framework_2) {
    "use strict";
                ...
                return _this.__invokeLifecycle(viewModel, 'canActivate', model)
                    ...
                    if (canActivate) {
                        return _this.compositionEngine.createController(instruction)
                            ...
                            _this.__invokeLifecycle(viewModel, 'bind', null);
